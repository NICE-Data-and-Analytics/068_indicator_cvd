...
# Load codelist
codelist_file <- "CVDRISKASS_COD_cprd_plus.txt"
...
# dbExecute(con, "DELETE FROM p068_codes WHERE category IN ('');")
# 
# dbExecute(con, "DROP TABLE IF EXISTS p068_cvdriskass_define;")
# 
